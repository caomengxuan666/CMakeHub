...
def main():
    ...
    parser.add_argument(
        "--path", required=True, help="Module path in repository (e.g., cmake/MyModule.cmake)"
    )
    ...
    parser.add_argument(
        "--category",
        default="utils",
        help="Module category (e.g., code_quality, build_optimization)",
    )
    parser.add_argument("--author", default="unknown", help="Module author")
    parser.add_argument(
        "--license", default="MIT", help="Module license (e.g., MIT, Apache-2.0, BSD3)"
    )
    parser.add_argument("--stars", type=int, default=0, help="GitHub stars")
    parser.add_argument(
        "--last-updated", default="2024-01-01", help="Last updated date (YYYY-MM-DD)"
    )
