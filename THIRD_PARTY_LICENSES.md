...
CMakeHub includes CMake modules from third-party repositories. Each module maintains its original license.
...
| Module | Repository | Author |
|--------|-----------|--------|
| add_gtest | [https://github.com/CLIUtils/cmake.git](https://github.com/CLIUtils/cmake.git) | CLIUtils |
